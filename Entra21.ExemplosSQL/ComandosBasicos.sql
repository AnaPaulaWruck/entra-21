...
CREATE TABLE produtos (
	id INTEGER PRIMARY KEY IDENTITY(1,1), -- IDENTITY(primeiroId, valorIncremento)
	nome VARCHAR(100),
	valor DECIMAL(5, 2),
...
-- Filtrar o produto em que o nome começa com Nescau
SELECT id, nome
	FROM produtos
	WHERE nome LIKE 'Nescau%';

-- Filtrar o produto em que o nome termina com Nescau
SELECT id, nome
	FROM produtos
	WHERE nome LIKE '%Nescau';

-- Filtrar o produto em que o nome contém Nescau	
SELECT id, nome
	FROM produtos
	WHERE nome LIKE '%Nescau%';
